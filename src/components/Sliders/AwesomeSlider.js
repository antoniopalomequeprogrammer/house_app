...
import imagen_cabecera from "assets/img/bg.jpg";
import imagen_cabecera2 from "assets/img/bg2.jpg";
import imagen_cabecera3 from "assets/img/bg3.jpg";
          ...
          >
            ...
            >
              <div
                ...
                data-src={imagen_cabecera}
              />
              <div
                style={{ backgroundColor: '#0095a9' }}
                data-src={imagen_cabecera2}
              />
              <div
                style={{ backgroundColor: '#ddff2d' }}
                data-src={imagen_cabecera3}
              />
            </AwesomeSlider>
          </AwesomeFrame>
        );
